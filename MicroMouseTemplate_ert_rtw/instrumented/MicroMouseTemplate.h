...
/* Block signals for system '<S53>/MATLAB System1' */
typedef struct {
  real_T MATLABSystem1[25];            /* '<S53>/MATLAB System1' */
  real_T rtu_0[25];
} B_MATLABSystem1_MicroMouseTem_T;

/* Block states (default storage) for system '<S53>/MATLAB System1' */
typedef struct {
  CircularBuffer_MicroMouseTemp_T obj; /* '<S53>/MATLAB System1' */
  boolean_T objisempty;                /* '<S53>/MATLAB System1' */
} DW_MATLABSystem1_MicroMouseTe_T;

/* Block signals for system '<S53>/MATLAB System3' */
typedef struct {
  real_T MATLABSystem3[10];            /* '<S53>/MATLAB System3' */
  real_T rtu_0[10];
} B_MATLABSystem3_MicroMouseTem_T;

/* Block states (default storage) for system '<S53>/MATLAB System3' */
typedef struct {
  CircularBuffer_MicroMouseTe_p_T obj; /* '<S53>/MATLAB System3' */
  boolean_T objisempty;                /* '<S53>/MATLAB System3' */
...
typedef struct {
  ...
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem3_c;/* '<S53>/MATLAB System1' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem2_ci;/* '<S53>/MATLAB System1' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem1_ci;/* '<S53>/MATLAB System1' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem2_c;/* '<S53>/MATLAB System1' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem1_c;/* '<S53>/MATLAB System1' */
  B_MATLABSystem3_MicroMouseTem_T MATLABSystem4;/* '<S53>/MATLAB System3' */
  B_MATLABSystem3_MicroMouseTem_T MATLABSystem3;/* '<S53>/MATLAB System3' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem2;/* '<S53>/MATLAB System1' */
  B_MATLABSystem1_MicroMouseTem_T MATLABSystem1;/* '<S53>/MATLAB System1' */
...
typedef struct {
  ...
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem3_c;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem2_ci;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem1_ci;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem2_c;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem1_c;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem3_MicroMouseTe_T MATLABSystem4;/* '<S53>/MATLAB System3' */
  DW_MATLABSystem3_MicroMouseTe_T MATLABSystem3;/* '<S53>/MATLAB System3' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem2;/* '<S53>/MATLAB System1' */
  DW_MATLABSystem1_MicroMouseTe_T MATLABSystem1;/* '<S53>/MATLAB System1' */
...
struct P_MicroMouseTemplate_T_ {
  ...
  boolean_T DataStoreMemory_InitialValue_p4;
                           ...
                           */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem6;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem5;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem4_c;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem3_c;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem2_ci;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem1_ci;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem2_c;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem1_c;/* '<S53>/MATLAB System1' */
  P_MATLABSystem3_MicroMouseTem_T MATLABSystem4;/* '<S53>/MATLAB System3' */
  P_MATLABSystem3_MicroMouseTem_T MATLABSystem3;/* '<S53>/MATLAB System3' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem2;/* '<S53>/MATLAB System1' */
  P_MATLABSystem1_MicroMouseTem_T MATLABSystem1;/* '<S53>/MATLAB System1' */
};
 ...
 *
 */
extern real32_T IMU_Accel[3];          /* '<S11>/Data Store Memory' */
extern real32_T IMU_Gyro[3];           /* '<S11>/Data Store Memory1' */
extern int32_T currTicksRS;            /* '<S1>/Data Store Memory2' */
extern int32_T currTicksLS;            /* '<S1>/Data Store Memory4' */
extern uint16_T ADC1s[9];              /* '<S10>/Data Store Memory' */
extern uint16_T ADC_H[9];              /* '<S10>/Data Store Memory1' */
extern uint16_T ADC_L[9];              /* '<S10>/Data Store Memory2' */
 ...
 *
 * Block '<S50>/Cast1' : Eliminate redundant data type conversion
 * Block '<S50>/Cast3' : Eliminate redundant data type conversion
 */
 ...
 * '<S12>'  : 'MicroMouseTemplate/Subsystem2'
 * '<S13>'  : 'MicroMouseTemplate/Subsystem3'
 * '<S14>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_LEFT'
 * '<S15>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_RIGHT'
 * '<S16>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_LEFT'
 * '<S17>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_RIGHT'
 * '<S18>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_LEFT'
 * '<S19>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_LEFT'
 * '<S20>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_RIGHT'
 * '<S21>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_RIGHT'
 * '<S22>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_LEFT/ECSoC'
 * '<S23>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_LEFT/ECSoC/ECSimCodegen'
 * '<S24>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_RIGHT/ECSoC'
 * '<S25>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_DOWN_RIGHT/ECSoC/ECSimCodegen'
 * '<S26>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_LEFT/ECSoC'
 * '<S27>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_LEFT/ECSoC/ECSimCodegen'
 * '<S28>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_RIGHT/ECSoC'
 * '<S29>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_FWD_RIGHT/ECSoC/ECSimCodegen'
 * '<S30>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_LEFT/ECSoC'
 * '<S31>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_LEFT/ECSoC/ECSimCodegen'
 * '<S32>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_LEFT/ECSoC'
 * '<S33>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_LEFT/ECSoC/ECSimCodegen'
 * '<S34>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_RIGHT/ECSoC'
 * '<S35>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_MOT_RIGHT/ECSoC/ECSimCodegen'
 * '<S36>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_RIGHT/ECSoC'
 * '<S37>'  : 'MicroMouseTemplate/GPIO for IR LEDs/LED_RIGHT/ECSoC/ECSimCodegen'
 * '<S38>'  : 'MicroMouseTemplate/IR LED Pattern/MATLAB Function'
 * '<S39>'  : 'MicroMouseTemplate/Motors/Fowards Backwards'
 * '<S40>'  : 'MicroMouseTemplate/Motors/MOTOR_EN'
 * '<S41>'  : 'MicroMouseTemplate/Motors/PWM Output'
 * '<S42>'  : 'MicroMouseTemplate/Motors/PWM Output1'
 * '<S43>'  : 'MicroMouseTemplate/Motors/MOTOR_EN/ECSoC'
 * '<S44>'  : 'MicroMouseTemplate/Motors/MOTOR_EN/ECSoC/ECSimCodegen'
 * '<S45>'  : 'MicroMouseTemplate/Motors/PWM Output/ECSoC'
 * '<S46>'  : 'MicroMouseTemplate/Motors/PWM Output/ECSoC/ECSimCodegen'
 * '<S47>'  : 'MicroMouseTemplate/Motors/PWM Output1/ECSoC'
 * '<S48>'  : 'MicroMouseTemplate/Motors/PWM Output1/ECSoC/ECSimCodegen'
 * '<S49>'  : 'MicroMouseTemplate/Subsystem/ADC2 IN10  IN1'
 * '<S50>'  : 'MicroMouseTemplate/Subsystem/get Highs and Lows'
 * '<S51>'  : 'MicroMouseTemplate/Subsystem/ADC2 IN10  IN1/ECSoC'
 * '<S52>'  : 'MicroMouseTemplate/Subsystem/ADC2 IN10  IN1/ECSoC/ECSimCodegen'
 * '<S53>'  : 'MicroMouseTemplate/Subsystem/get Highs and Lows/Subsystem'
 * '<S54>'  : 'MicroMouseTemplate/Subsystem/get Highs and Lows/Subsystem1'
 * '<S55>'  : 'MicroMouseTemplate/Subsystem/get Highs and Lows/Subsystem2'
 * '<S56>'  : 'MicroMouseTemplate/Subsystem2/CTRL_LEDs'
 * '<S57>'  : 'MicroMouseTemplate/Subsystem2/LED_0'
 * '<S58>'  : 'MicroMouseTemplate/Subsystem2/LED_1'
 * '<S59>'  : 'MicroMouseTemplate/Subsystem2/LED_2'
 * '<S60>'  : 'MicroMouseTemplate/Subsystem2/CTRL_LEDs/ECSoC'
 * '<S61>'  : 'MicroMouseTemplate/Subsystem2/CTRL_LEDs/ECSoC/ECSimCodegen'
 * '<S62>'  : 'MicroMouseTemplate/Subsystem2/LED_0/ECSoC'
 * '<S63>'  : 'MicroMouseTemplate/Subsystem2/LED_0/ECSoC/ECSimCodegen'
 * '<S64>'  : 'MicroMouseTemplate/Subsystem2/LED_1/ECSoC'
 * '<S65>'  : 'MicroMouseTemplate/Subsystem2/LED_1/ECSoC/ECSimCodegen'
 * '<S66>'  : 'MicroMouseTemplate/Subsystem2/LED_2/ECSoC'
 * '<S67>'  : 'MicroMouseTemplate/Subsystem2/LED_2/ECSoC/ECSimCodegen'
 * '<S68>'  : 'MicroMouseTemplate/Subsystem3/SW_1'
 * '<S69>'  : 'MicroMouseTemplate/Subsystem3/SW_2'
 * '<S70>'  : 'MicroMouseTemplate/Subsystem3/SW_1/ECSoC'
 * '<S71>'  : 'MicroMouseTemplate/Subsystem3/SW_1/ECSoC/ECSimCodegen'
 * '<S72>'  : 'MicroMouseTemplate/Subsystem3/SW_2/ECSoC'
 * '<S73>'  : 'MicroMouseTemplate/Subsystem3/SW_2/ECSoC/ECSimCodegen'
 */
